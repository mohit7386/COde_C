...
//The change in the function definition value will not effect the value of function call or main function....or you can use same variable for printing in function call and function definition....